...
The supplied `WM_BubbleBash2_Samsung_SGHI617_EN_IGP_Mi-spaces.im-59e77bb52515.cab` now boots through PocketHLE's Windows Mobile path and reaches the game's native display initialization. The tested payload is the ARM Thumb executable `Bubble Bash 2.exe` from Gameloft.
...
- `frames/frame_000000.ppm` — captured fixed-run framebuffer.
